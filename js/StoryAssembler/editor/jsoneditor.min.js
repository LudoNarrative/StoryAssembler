...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  showEditJSON: function() {
    ...
    // Start the textarea with the current value
     var formattedJSON = formatJSON(this.getValue());
     this.editjson_textarea.value = JSON.stringify(formattedJSON, null, 2);
 ...
 try {
      var json = JSON.parse(unChew(this.editjson_textarea.value));
      this.setValue(json);
      this.hideEditJSON();
    }
    catch(e) {
